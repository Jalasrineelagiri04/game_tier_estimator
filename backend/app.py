...
try:
    model = joblib.load('D:/gaming-skill-estimator/backend/model/skill_model.pkl')
    label_encoder = joblib.load('D:/gaming-skill-estimator/backend/model/label_encoder.pkl')
